...
deals = Deal.create([{image_url:'no-image.jpg',title: 'Pizza Frenzy', description:'With every Pizza the second is on us',dealable_id: 1, dealable_type: "FoodStore", starts_at:'Every Friday'},
  {image_url:'no-image.jpg',title: 'All you can eat at Leuteris', description:'Eat up',dealable_id: 3, dealable_type: "FoodStore", starts_at:'Every Sunday'}])

ads = Ad.create([{image_url:'no-image.jpg',title: 'Trinity the ultimate clubbing experience', description:'Daily House/RnB, Fridays and Saturdays guest DJ SoundBlast', adable_id: 1, adable_type: "EntertainmentStore" },
  {image_url:'no-image.jpg',title: 'Roots Rock-bar', description:'Chill out with relaxing music', adable_id: 3, adable_type: "EntertainmentStore" }])
